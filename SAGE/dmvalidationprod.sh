...
if [[ ${ROLE} = "train" ]]; then
	EVALUATION_IDS=8533480
elif [[ ${ROLE} = "score" ]]; then
	EVALUATION_IDS=8533482,8533484
else
...
EVALUATION_ROLES=\{\"8533480\":\"TRAIN\",\"8533482\":\"SCORE_SC_1\",\"8533484\":\"SCORE_SC_2\"\}
...
--name ${ROLE}-validator brucehoff/challengedockeragent mvn "exec:java" "-DentryPoint=org.sagebionetworks.validation.SubmissionValidationAgent"
